    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Have Fun with React Clicky Game!!</h1>
        </header>
        <h3 className="App-intro">
          <strong>Click on any programming language image to earn points, but don't click on any, more than once!</strong> 
      ...
      <div className="container">
        <span className="text-muted">&copy;Mengistu - Clicky Game - React app.</span>
      </div>
    </footer> 
      </div>
    );
